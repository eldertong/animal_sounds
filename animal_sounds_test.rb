     ...
     def test_dog_name
        ...
        def test_dog_sound
            ...
            assert_equal("Woof", animal.sound)
               ...
               def test_whats_the_dog_say
                rex = Dog.new("rex")
                assert_equal("rex says Woof", rex.what_animal_says())
            end
     def test_fox_name
        ...
        def test_whats_the_fox_say
                ylvis = Fox.new("ylvis")
                assert_equal("ylvis says yippy", ylvis.what_animal_says())
            end
end